...
#include "uart.h"
#include "stdio.h"
extern uint8_t sent_size,receive;
...
void nrf_Irq_Init(void)
{
	...
	/* Tell system that you will use PC10 for EXTI_Line1 */
	...
	/* PC10 is connected to EXTI_Line1, which has EXTI1_IRQn vector */
